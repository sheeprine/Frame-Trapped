namespace FrameTrapped.StreetFighterLibrary.Utilities
{
    ...
    public static class FighterDataAE2012
    {
        ...
        public static FighterViewModel Ryu()
        {
            ...
            tmpHitList = new BindableCollection<HitViewModel>();
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 80, 0, 100, 0, -250, new[] { HitViewModel.CancelAbilityEnum.Super }, 3, 2, 45, 0, 0, "1~16f Invincible, 6f~ airborne, knock down, "));
            ...
            tmpHitList = new BindableCollection<HitViewModel>();
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 0, 0, 0, 0, 0, new[] { HitViewModel.CancelAbilityEnum.Super }, 0, 0, 0, 0, 0, ""));

            moveList.Add(new MoveViewModel("Shinkuu Hadouken (Slow)", MoveViewModel.MoveTypeEnum.Special, tmpHitList, tmpCommand));
            ...
            moveList.Add(new MoveViewModel("Shinkuu Hadouken (Normal)", MoveViewModel.MoveTypeEnum.Special, tmpHitList, tmpCommand));
            ...
            moveList.Add(new MoveViewModel("Metsu Hadouken", MoveViewModel.MoveTypeEnum.Special, tmpHitList, tmpCommand));
            ...
            moveList.Add(new MoveViewModel("Metsu Shoryuken", MoveViewModel.MoveTypeEnum.Special, tmpHitList, tmpCommand));
        ...
        public static FighterViewModel Ken()
        {
            ...
            moveList.Add(new MoveViewModel("Inazuma Kick", MoveViewModel.MoveTypeEnum.Unique, tmpHitList, tmpCommand));
            ...
            moveList.Add(new MoveViewModel("Step Kick", MoveViewModel.MoveTypeEnum.Unique, tmpHitList, tmpCommand));
            ...
            tmpHitList = new BindableCollection<HitViewModel>();
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 50, 0, 50, 0, -250, new[] { HitViewModel.CancelAbilityEnum.Super }, 12, 0, 43, 0, 3, "17~18f cancellable, can juggle"));
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 40, 0, 50, 0, 0, new[] { HitViewModel.CancelAbilityEnum.Super }, 0, 0, 0, 0, 0, ""));
            ...
            tmpHitList = new BindableCollection<HitViewModel>();
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 60, 0, 70, 0, 20, new[] { HitViewModel.CancelAbilityEnum.Super }, 6, 1, 17, -6, -2, "7~20f , 1st hit forces stand, Pursuit Property, 1st hit cancellable, Armor Break"));
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 50, 0, 50, 0, 10, new HitViewModel.CancelAbilityEnum[] { }, 0, 2, 0, 0, 0, ""));
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 50, 0, 50, 0, 10, new HitViewModel.CancelAbilityEnum[] { }, 0, 2, 0, 0, 0, ""));
            ...
            tmpHitList = new BindableCollection<HitViewModel>();
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 60, 0, 50, 0, 20, new[] { HitViewModel.CancelAbilityEnum.Super }, 6, 2, 23, -4, -0, "8~41f , 1st hit forces stand, Pursuit Property, 1st hit cancellable, Armor Break"));
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 30, 0, 40, 0, 10, new HitViewModel.CancelAbilityEnum[] { }, 0, 2, 0, 0, 0, ""));
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 30, 0, 40, 0, 10, new HitViewModel.CancelAbilityEnum[] { }, 0, 1, 0, 0, 0, ""));
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 30, 0, 40, 0, 10, new HitViewModel.CancelAbilityEnum[] { }, 0, 2, 0, 0, 0, ""));

            moveList.Add(new MoveViewModel("Medium Tatsumaki Senpukyaku", MoveViewModel.MoveTypeEnum.Special, tmpHitList, tmpCommand));
            ...
            tmpHitList = new BindableCollection<HitViewModel>();
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 60, 0, 50, 0, 20, new[] { HitViewModel.CancelAbilityEnum.Super }, 6, 2, 24, -5, -1, "9~50f , 1st hit forces stand, Pursuit Property, 1st hit cancellable, Armor Break"));
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 30, 0, 40, 0, 10, new HitViewModel.CancelAbilityEnum[] { }, 0, 1, 0, 0, 0, ""));
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 30, 0, 40, 0, 10, new HitViewModel.CancelAbilityEnum[] { }, 0, 1, 0, 0, 0, ""));
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 30, 0, 40, 0, 10, new HitViewModel.CancelAbilityEnum[] { }, 0, 1, 0, 0, 0, ""));
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 30, 0, 40, 0, 10, new HitViewModel.CancelAbilityEnum[] { }, 0, 2, 0, 0, 0, ""));

            moveList.Add(new MoveViewModel("Hard Tatsumaki Senpukyaku", MoveViewModel.MoveTypeEnum.Special, tmpHitList, tmpCommand));
            ...
            tmpHitList = new BindableCollection<HitViewModel>();
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 50, 0, 50, 0, -250, new[] { HitViewModel.CancelAbilityEnum.Super }, 6, 2, 23, -3, 1, "8~38f , 1st hit forces stand, Pursuit Property, 1st hit cancellable, Armor Break"));
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 40, 0, 50, 0, 0, new HitViewModel.CancelAbilityEnum[] { }, 0, 1, 0, 0, 0, ""));
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 40, 0, 50, 0, 0, new HitViewModel.CancelAbilityEnum[] { }, 0, 1, 0, 0, 0, ""));
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 40, 0, 50, 0, 0, new HitViewModel.CancelAbilityEnum[] { }, 0, 1, 0, 0, 0, ""));
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 40, 0, 50, 0, 0, new HitViewModel.CancelAbilityEnum[] { }, 0, 1, 0, 0, 0, ""));

            moveList.Add(new MoveViewModel("EX Tatsumaki Senpukyaku", MoveViewModel.MoveTypeEnum.ExtraSpecial, tmpHitList, tmpCommand));
            ...
            tmpHitList = new BindableCollection<HitViewModel>();
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 50, 0, 50, 0, 10, new HitViewModel.CancelAbilityEnum[] { }, 8, 2, 10, 0, 0, "Pursuit Property"));
            

            moveList.Add(new MoveViewModel("Light Tatsumaki Senpukyaku (Air)", MoveViewModel.MoveTypeEnum.Special, tmpHitList, tmpCommand));
            ...
            tmpHitList = new BindableCollection<HitViewModel>();
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 60, 0, 50, 0, 10, new HitViewModel.CancelAbilityEnum[] { }, 7, 1, 10, 0, 0, "Pursuit Property"));

            moveList.Add(new MoveViewModel("Medium Tatsumaki Senpukyaku (Air)", MoveViewModel.MoveTypeEnum.Special, tmpHitList, tmpCommand));
            ...
            tmpHitList = new BindableCollection<HitViewModel>();
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 70, 0, 50, 0, 10, new HitViewModel.CancelAbilityEnum[] { }, 7, 1, 10, 0, 0, "Pursuit Property"));

            moveList.Add(new MoveViewModel("Hard Tatsumaki Senpukyaku (Air)", MoveViewModel.MoveTypeEnum.Special, tmpHitList, tmpCommand));
            ...
            moveList.Add(new MoveViewModel("EX Tatsumaki Senpukyaku (Air)", MoveViewModel.MoveTypeEnum.ExtraSpecial, tmpHitList, tmpCommand));
            ...
            tmpHitList = new BindableCollection<HitViewModel>();
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 40, 0, 0, 0, -1000, new HitViewModel.CancelAbilityEnum[] { }, 2, 2, 43, -29, 0, "1~3f invincible, 4, Pursuit Property"));
            ...
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 50, 0, 0, 0, 0, new HitViewModel.CancelAbilityEnum[] { }, 0, 1, 0, 0, 0, ""));
            ...
            tmpHitList = new BindableCollection<HitViewModel>();
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 40, 0, 0, 0, -1000, new HitViewModel.CancelAbilityEnum[] { }, 3, 2, 0, -29, 0, "1~4f invincible, 5, Pursuit Property"));
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 40, 0, 0, 0, 0, new HitViewModel.CancelAbilityEnum[] { }, 0, 1, 0, 0, 0, ""));
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 40, 0, 0, 0, 0, new HitViewModel.CancelAbilityEnum[] { }, 0, 8, 0, 0, 0, ""));
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 50, 0, 0, 0, 0, new HitViewModel.CancelAbilityEnum[] { }, 0, 1, 0, 0, 0, ""));
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 100, 0, 0, 0, 0, new HitViewModel.CancelAbilityEnum[] { }, 0, 3, 0, 0, 0, ""));
            ...
            moveList.Add(new MoveViewModel("Medium Shoryureppa", MoveViewModel.MoveTypeEnum.Super, tmpHitList, tmpCommand));
            ...
            moveList.Add(new MoveViewModel("Hard Shoryureppa", MoveViewModel.MoveTypeEnum.Super, tmpHitList, tmpCommand));
            ...
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 30, 0, 0, 0, 0, new HitViewModel.CancelAbilityEnum[] { }, 0, 5, 0, 0, 0, ""));
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 30, 0, 0, 0, 0, new HitViewModel.CancelAbilityEnum[] { }, 0, 5, 0, 0, 0, ""));
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 30, 0, 0, 0, 0, new HitViewModel.CancelAbilityEnum[] { }, 0, 1, 0, 0, 0, ""));

            moveList.Add(new MoveViewModel("Shinryuken", MoveViewModel.MoveTypeEnum.Ultra, tmpHitList, tmpCommand));
            ...
            tmpHitList = new BindableCollection<HitViewModel>();
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 75, 0, 0, 0, 0, new HitViewModel.CancelAbilityEnum[] { }, 7, 2, 82, -40, 0, "1~7f invincible"));
            ...
            tmpHitList.Add(new HitViewModel(HitViewModel.BlockTypeEnum.Mid, 225, 0, 0, 0, 0, new HitViewModel.CancelAbilityEnum[] { }, 0, 0, 0, 0, 0, ""));

            moveList.Add(new MoveViewModel("Guren Senpukyaku", MoveViewModel.MoveTypeEnum.Ultra, tmpHitList, tmpCommand));
